const SPELL_DATA = [
  {
    ...
    "id": "grind",
    "selectable": true,
    "desc": "获得药水(X＋Y). <span class='italic'>无冷却.</span>",
    "qualificationCost": 0,
    "unlocked": true,
    "castsPerTurn": -1,
    "slots": 2,
